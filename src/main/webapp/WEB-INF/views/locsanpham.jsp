...
<body>
	...
	<div class="container" style="margin-top: 5%">
		...
		<div class="row">
			...
			<div id="locSanPham" class="row" style="width: 100%;margin-left: 15px;">
				...
				<div class="row" style="width: 100%;background-color: rgba(0, 0, 0, 0.1)">
					...
					<div class="col-md-4">
						<c:forEach var="i" items="${sizes }">
							<button class="btn btnSize" style=" margin: 2px; background: white;" data-text="${i.getTenSize()}" data-value="${i.getId() }">${i.getTenSize()}</button>
						</c:forEach>
					</div>
				</div>
			</div>
	...
	<script type="text/javascript" src='<c:url value="/resources/js/locsanpham.js" />'></script>
